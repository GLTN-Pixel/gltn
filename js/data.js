...
const UI = {
  ...
  pendingCopyrightFallback: '内容版权信息待补充',
...
const ENTRIES = [
  {
    ...
    portrait: 'img/characters/char-base-portrait.png',
    splash: 'img/characters/char-base-splash.jpg',
    quote: '（占位 · 基础形态台词）',
    short: '（占位 · 基础形态简介）',
  ...
  },
  {
    ...
    portrait: 'img/characters/char-wrath-portrait.png',
    splash: 'img/characters/char-wrath-splash.jpg',
    quote: '（占位）',
    short: '（占位 · 愤怒形态简介）',
  ...
  },
  {
    ...
    aliases: ['贪婪形态'],
    searchTerms: ['greed'],
    portrait: 'img/characters/char-greed-portrait.png',
    splash: 'img/characters/char-greed-splash.jpg',
    quote: '（占位）',
    short: '（占位）',
  ...
  },
  {
    ...
    portrait: 'img/characters/char-gluttony-portrait.png',
    splash: 'img/characters/char-gluttony-splash.jpg',
    quote: '（占位）',
    short: '（占位）',
    detail: '<p>（占位）</p>',
  ...
  },
  {
    ...
    short: '（占位）',
    detail: '<p>（占位）</p>',
    baseStats: { health: 300, hunger: 150, sanity: 250 },
    pros: ['（占位）'],
    cons: ['（占位）'],
    abilities: [],
  ...
  },
  {
    ...
    aliases: ['懒惰形态'],
    searchTerms: ['sloth'],
    portrait: 'img/characters/char-sloth-portrait.png',
    splash: 'img/characters/char-sloth-splash.jpg',
    quote: '（占位）',
    short: '（占位）',
    detail: '<p>（占位）</p>',
