...
const ENTRIES = [
  {
    ...
    { name: "屹立不倒(红眼)", type: "passive", desc: "当生命值小于10%时，获得15s无敌时间，\n期间按照自己已损失的生命值提高自己的攻击力（每损失4%生命提高1%攻击力）攻速略有提升(每损失4%生命提高0.02%攻击速度)，\n如果击杀目标则按照击杀目标最大生命值的1%回复自身生命，CD1天。\n若无敌时间结束血量仍小于10%，则攻击倍率降低为50%，移动速度降低为50%（直到血量＞10%才可以解除）。" ,}],
  ...
  },
  {
    ...
    detail: '技能：地狱之业火\n在物品栏时右键立刻消耗40%最大生命值，获得持续4s的力场护盾（此力场护盾效果同铥矿头盔）\n随后每秒损失6点生命值和20点能量直到生命值达到6后或者能量达到200后不再下降。\n技能持续期间，每次损失生命对周围单位造成30伤害，\n且持续期间攻击倍率固定为3.0，暴击率变为30% 暴击伤害提升15%每次暴击回复20生命。{{char-wrath}}',
    stats: [
      { label: '伤害', value: '68' },
      { label: '距离', value: '2' }
    ],
  ...
  },
  {
    ...
    detail: '右键技能技能：如梦一般的泡影（消耗25能量，CD8s）\n可以像哑铃一样抛物线扔出，在落地点造成34点AOE伤害，\n同时在落点召唤一枚可造成100 AOE伤害的陨石（没有燃烧效果和击飞物品效果，且对哥杀伤害减半）\n如果哥杀在陨石范围内，则获得持续4s的力场护盾，此力场护盾效果同铥矿头盔\n增加15%的攻击力和移动速度，并获得额外36攻击力和吸血（每次攻击回5）持续15s。{{char-wrath}}',
    stats: [
      { label: '伤害', value: '68' }
    ],
    related: ['char-wrath']
  },
  {
    ...
    short: '靠近铁匠解锁配方',
    detail: '右键投掷，每次消耗武器25%耐久。\n命中敌人后会插在敌人身上造成25%减速。\n玩家可以选择将插在敌人身上的武器拔出(右键怪物或者快捷键R)，造成怪物1%最大生命值的伤害，这部分伤害会以流血形式扣除。{{build-blacksmith}}',
    stats: [
      { label: '伤害', value: '68' },
      { label: '耐久', value: '150' }
    ],
  ...
  },
  {
    ...
    short: '靠近铁匠解锁配方',
    detail: '攻击同原版吹箭。\n命中敌人后会插在敌人身上造成25%减速。\n玩家可以选择将插在敌人身上的武器拔出(右键怪物或者快捷键R)，这部分伤害会以流血形式扣除。{{build-blacksmith}}',
    stats: [
      { label: '伤害', value: '42.5' },
  ...
  },
  {
    ...
    short: '击杀犀牛获得',
    detail: '斧子在地上插三天就会消失。\n击杀远古犀牛获得，无耐久具有多用斧稿功能。\n且给予3个金锄头可以开启一键3*3功能,伤害68。\n右键消耗（自动检查物品栏）2个噩梦燃料开启特殊功能分身。\n（持续15S冷却20S）此时攻击距离为2，若在攻击距离1攻击可造成双倍伤害且分身状态下工作具有双倍效率。\n',
    stats: [
      { label: '伤害', value: '68' },
      { label: '耐久', value: '无耐久' }
    ],
  ...
  },
  {
    ...
    short: '这是我年轻时候用过的钱袋',
    detail: '能量0—250（穷鬼）时，\n可消耗60能量/贽金制作，2×3=6个格子，只可以用来装 贽金、古金币、护符、宝石。\n在袋子里有物品的情况下，可以为哥杀提供25%加速。{{item-zhi-coin}}',
    stats: [
      { label: '格子', value: '6' }
    ],
    related: ['item-zhi-coin']
  },
  {
    ...
    short: '那时的我小有所成',
    detail: '能量250—500（贫民）时，\n可消耗120能量/贽金制作，3×4=12个格子，只可以用来装 贽金、古金币、护符、宝石。\n在袋子里有物品的情况下，可以为哥杀提供25%加速和贝雷帽相等的回san。{{item-zhi-coin}}',
    stats: [
      { label: '格子', value: '12' }
    ],
    related: ['item-zhi-coin']
  ...
  },
  {
    ...
    { label: '红宝石', value: '半径20码灭火' },
    { label: '蓝宝石', value: '半径20码的敌方单位冻结，持续20s' },
    { label: '紫宝石', value: '半径20码的敌方单位速度变为原来的三分之一，持续30s' },
    { label: '绿宝石', value: '半径 30 范围内的所有非食用类作物以及树瞬间生长到最大阶段(原版应用造林学)' },
    { label: '黄宝石', value: '选择半径20码的空地释放火女的火球术(此时右键空地也能响指)' },
  ...
  },
  {
    ...
    aliases: ['米达斯的黄金手'],
    searchTerms: ['item-midas-golden-glove'],
    icon: 'img/items/huangjinshou1/item-midas-golden-glove-1.png',
    short: '点石成金也不是不可能',
    detail: '由原初之握升级而成，\n1.手套功能升级\n获得宝石转换功能，自带一个ui，格子里可以放各色宝石，\n当格子里有宝石可以右键人物(选择变为响指)进行打响指，消耗单个宝石/宝石组合获得不同的效果镶嵌彩虹宝石后打响指升级为等级2\n2.战斗宝剑功能\n辉耀：可z键开启每秒消耗6能量/贽金对周围单位造成每秒30点伤害，此功能在能量低于6时自动关闭。\n点金：杀死敌人后会把敌人变成愚者之金，\n3.点金法杖功能\n万能工具可锤,稿,砍,挖,耕\n每天一次将不需要的物品1:1转换为贽金。\n',
    stats: [{ label: '宝石种类', value: '响指效果' },
    { label: '红+蓝', value: '把自身和周围 16 距离单位范围内的所有玩家的个体温度立刻恢复到 35 度，并清空潮湿度。' },
    { label: '红+紫', value: '复活自己身边所有玩家，每复活一人扣除自己15点san值' },
    { label: '红+黄', value: '选择半径20码的空地释放矮星(此时右键空地也能响指)' },
    { label: '红+绿', value: '同分解法杖(此时右键地面物品也能响指)' },
    { label: '红+橙', value: '右键点击地面即可瞬移，瞬移后15s内每秒消耗5点饥饿度回复5点血量(此时右键空地也能响指)' },
    { label: '蓝+紫', value: '消耗5点san值，使得自己的下次攻击可以冰冻敌方生物，并回复自己5点生命' },
    { label: '蓝+黄', value: '选择半径20码的空地释放极光(此时右键空地也能响指)' },
    { label: '蓝+绿', value: '使角色附近半径 30 范围内的未长成的食用类作物瞬间生长成熟。被它催熟的农作物无法变为巨大作物(类原版园艺学)' },
    { label: '蓝+橙', value: '半径20码的敌方单位被麦斯威尔的暗影牢笼囚禁' },
    { label: '紫+黄', value: '立刻进入月黑' },
    { label: '紫+绿', value: '获得一个20%--80%耐久的建造护符' },
    { label: '紫+橙', value: '开启全图无条件传送一次' },
    { label: '黄+绿', value: '秒杀周围所有影怪' },
    { label: '黄+橙', value: '将自己传送到大远古塔/远古守护者/远古档案馆附近' },
    { label: '绿+橙', value: '15s内自动拾取角色周围半径 4 范围内的所有可堆叠的物品或物品形态的小形生物，并采收可收获s作物' },
    { label: '彩虹宝石', value: '获得其他6色宝石各一颗，并切换月相为月圆' },
    { label: '原版本7色宝石', value: '升级为等级3，人物获得随机1个7宝和宝石之树的种子(宝石树的特性同原版萌芽石)；\n等级3时，改为33%获得5+贪婪值/4的贽金，33%受到一次雷击扣除自己一半生命值，33%恢复自己25%三维(给个辉耀的点金特效)，1%的概率获得1个宝石之树的种子' },
  ...
  },
  {
    ...
    detail: '召唤：在冰箱中心空出，周围放满8个腐烂物品；\n蛋黄酱在地上时鼠标右键键可以怀抱蛋黄酱，可以回san和缓慢回血（效果同帐篷，并消耗蛋黄酱25%饥饿度）；\n帽子功能（可以右键切换形态）：给予牛帽/眼球伞/矿灯帽改变可以形态，具有相应属性，且带帽子时有一个贝雷帽的回san效果，\n装备时，吸收一定量的雨露值，蛋黄酱开始发芽并开花共五个阶段。\n开花效果：右键耕地使用，以蛋黄酱为中心，灭火器范围内的农地湿度和肥度会达到峰值，农作物被照料。（有一个飞到天上的动画）{{build-blacksmith}}',
    stats: [
      { label: '生命', value: '600' },
      { label: '饥饿度', value: '600' },
      { label: '饥饿速率', value: '0' },
